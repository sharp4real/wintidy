# WinTidy Debloat Script

![Wallpaper](https://github.com/sharp4real/wintidy/blob/main/Wallpaper.png?raw=true)
...
Or download manually from [Releases](https://github.com/sharp4real/wintidy/releases/download/v1.1/WinTidy.ps1).
